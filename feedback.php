...
<h2 align="center" style="font-family:'typo'; color:RED">FEEDBACK/REPORT A PROBLEM</h2>
...
<div class="col-md-10">
<a href="mailto:razairshad04@gmail.com" style="color:WHITE">razairshad04@gmail.com</a><br /><br />
...
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#developers">Our-Team</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Our-Team</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/ip.jpg" width=100 height=100 alt="IRSHAD" class="img-rounded">
     <img src="image/pallo3.jpg" width=100 height=100 alt="IRSHAD" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">IRSHAD HUSSAIN</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Front-End</h4>
		<h4 style="font-family:'typo' ">razairshad04@gmail.com</h4>

    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">PALLAVI SINGH</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">Front-End</h4>
    <h4 style="font-family:'typo' ">G.L Bajaj Institute of Technology and Management , Greater Noida</h4>
